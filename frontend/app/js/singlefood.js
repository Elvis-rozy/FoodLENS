...
<div class="for-fat">
  ...
  <div class="total-fat">
    ...
    <span>${parseInt(((nf_total_fat - nf_saturated_fat) / nf_total_fat)*100)}%</p></span>
</div> 
</div>
 <div class="total-fat">
...
<div class="t-p">
    ...
    <span><p>${parseInt((nf_potassium/nf_total)*100)}%</p></span>
        ...
        <div class="food-to-dashboard">Add to Dashboard</div>
      </div>
...
`;
          ...
          const AddFood = document.querySelector(".food-to-dashboard");
          AddFood.addEventListener("click", () => {
            addToDashboard(data.food);
          });
        })
        .catch((error) => {
          console.log(error);
